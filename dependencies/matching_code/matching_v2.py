...
def compute_point_to_floorplan(base_path, building_name, split="test"):
    ...
    if laz_points.shape[0] > 2. * num_points_json:
        choice_idx = np.random.choice(laz_points.shape[0], num_points_json, replace=False)
...
if __name__ == "__main__":
    ...
    for building_name in building_names:
        ...
        print('===============================================================')
        print('============working on : ', building_name)
        print('===============================================================')

        compute_point_to_floorplan(base_path, building_name, split="test")
